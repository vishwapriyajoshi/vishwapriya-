# -*- coding: utf-8 -*-
"""
Created on Tue Dec  1 10:52:53 2020
...
import pandas as pd
#import Dataset 
anime = pd.read_csv("C:/Users/user/Downloads/book.csv")
anime.shape #shape
anime.columns
anime #genre columns
...
tfidf_matrix = tfidf.fit_transform(anime)   #Transform a count matrix to a normalized tf or tf-idf representation
...
def get_anime_recommendations(Name,topN):
    ...
    cosine_scores = sorted(cosine_scores,key=lambda x:x[0],reverse = True)
    
    # Get the scores of top 10 most similar anime's 
    cosine_scores_10 = cosine_scores[0:+1]
